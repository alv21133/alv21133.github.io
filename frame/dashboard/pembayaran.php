    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content pb-0">
         ...
         <!--  Traffic   tabel detail customers-->
            ...
            <?php 
                        $id=$_GET['%rq%'];      
                        $view=$dbkonek->query("select No ,Customer_ID,Tanggal, Pemakaian_Bulan_Lalu,Pemakaian_Bulan_Ini,customer.nama from pemakaian join customer on Customer_ID = ID  where No='$id' limit 1");
                            ...
                            <div class="card-body">
                                <h4 class="mb-7 font-weight-bold" >ID : <?php echo $data['Customer_ID']?> <h4 class="mb-7 font-weight-bold" style="text-align:center"><?php echo $data['nama']?></h4></h4>                                    
                                    <form action="" method="POST">
                                            ...
                                            <div class="row"> 
                                                <div class="col-md-4">
                                                    <img   src="../dashboard/images/tulis.png" style=" width:150px; margin-left:7rem" ></img>
                                                    </div>
                                                 ...
                                                 <div class="col-md-8">
                                                        <div class="form-row ">
                                                            ...
                                                            <div class="col-md-6 mb-3">
                                                                    ...
                                                                    <input type="text" name="tanggal"class="form-control is-valid font-weight-bold" id="validationServer02"  readonly value="<?php  echo date('d-m-Y',strtotime($data['Tanggal'])) ?>" required>
                                                                            <div class="valid-feedback">
                                                                                GoWater Data ! 
                                                                     </div>
                                                            </div>
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="col-md-6 mb-3">
                                                        ...
                                                        <script script type="text/javascript">
                                                                ...
                                                                var y = document.getElementById("tagihan").value;
